...
function automatic signed [5:0] div_by_pivot(input signed [7:0] num, input signed [2:0] a0);
    begin
        case (a0)
            ...
            3'b011: div_by_pivot = num[5:0]*6'd43;
            3'b101: div_by_pivot = num[5:0]*6'd21;
...
assign sol1    = arshift6_w16(num_x1_r, det_tz)* det_inv; // x1
assign sol2    = arshift6_w16(num_x2_r, det_tz)* det_inv; // x2
