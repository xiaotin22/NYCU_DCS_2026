...
logic [7:0] result_add0, result_add1, result_gray;
...
task gen_ans; begin
	...
	result_add0 = large1 + small2; 
	result_add1 = small1 + large2; 
	result_gray = result_add0 ^ {1'b0, result_add0[7:1]}; 
	...
	$display ("\033[0;34mBitwise: Add1=%8b (%3d), Add2=%8b (%3d)\033[m", result_add0, result_add0, result_add1, result_add1);
	$display ("\033[0;34mOutput: out_num0=%8b (%3d), out_num1=%8b (%3d)\033[m", result_add0, result_add0, result_gray, result_gray);
end endtask

task check_ans; begin
	if((out_num0 !== result_gray) || (out_num1 !== result_add1)) begin
		fail;
		$display ("--------------------------------------------------------------------------------------------------------------------------------------------");
		$display ("                                                    ANSWER FAIL!                                                            ");
		$display ("--------------------------------------------------------------------------------------------------------------------------------------------");
		...
		$display ("                                         Correct answer:    %3d      %3d                                          ",result_gray, result_add1);
